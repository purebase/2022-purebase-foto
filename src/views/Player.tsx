    ...
    <div className={`max-w-[600px] max-h-[240px] m-auto ${className}`} {...other} ref={ref}>
      ...
      <div className="bg-slate-50 text-slate-500 dark:bg-slate-600 dark:text-slate-200 rounded-b-xl flex items-center">
        <div className="flex-auto flex items-center justify-evenly">
          <TWPlayerButton aria-label="Add to favorites">
          ...
          <TWPlayerButton className="hidden sm:block lg:hidden xl:block" aria-label="Previous">
          ...
          <TWPlayerButton aria-label="Rewind 10 seconds">
            <svg width="24" height="24" fill="none">
              <path
        ...
        <div className="flex-auto flex items-center justify-evenly">
          <TWPlayerButton aria-label="Skip 10 seconds">
            <svg width="24" height="24" fill="none">
              <path
          ...
          <TWPlayerButton className="hidden sm:block lg:hidden xl:block" aria-label="Next">
            <svg width="24" height="24" fill="none">
              <path
          ...
          <TWPlayerButton className="rounded-lg text-xs leading-6 font-semibold px-2 border-2 border-slate-500 text-slate-500 dark:text-slate-100 dark:ring-0 dark:bg-slate-500 hover:ring-cyan-500">
            1x
          </TWPlayerButton>
        </div>
      </div>
