export const SiteHeader = () => {
    ...
    return (
        <div className="nextra-nav-container sticky top-0 z-20 w-full bg-transparent">
            <div
                className="nextra-nav-container-blur pointer-events-none absolute z-[-1] h-full w-full bg-white dark:bg-dark shadow-[0_2px_4px_rgba(0,0,0,.02),0_-1px_0_rgba(0,0,0,.06)_inset] dark:shadow-[0_-1px_0_rgba(255,255,255,.1)_inset] contrast-more:shadow-[0_0_0_1px_#000] contrast-more:dark:shadow-[0_0_0_1px_#fff]"></div>
            <nav
                className="mx-auto flex h-[var(--nextra-navbar-height)] max-w-[90rem] items-center justify-end gap-2 pl-[max(env(safe-area-inset-left),1.5rem)] pr-[max(env(safe-area-inset-right),1.5rem)]">
                <a className="flex ltr:mr-auto rtl:ml-auto items-center hover:opacity-75" href="/">
                    <svg height="32" viewBox="0 0 333 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                            <linearGradient id="paint1_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                            <linearGradient id="paint2_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                            <linearGradient id="paint3_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                            <linearGradient id="paint4_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                            <linearGradient id="paint5_linear" x1="303.038" y1="0" x2="303.038" y2="74.4325"
                                            gradientUnits="userSpaceOnUse">
                                <stop stop-color="#1E90FF"></stop>
                                <stop offset="1" stop-color="#FF1E56"></stop>
                            </linearGradient>
                    ...
                    <span className="sr-only">Turborepo</span></a><a
                className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 -ml-2 hidden whitespace-nowrap p-2 md:inline-block text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                aria-selected="false" href="/docs">Docs</a><a
                className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 -ml-2 hidden whitespace-nowrap p-2 md:inline-block text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                aria-selected="false" href="/blog">Blog</a><a
                href="https://vercel.com/contact/turborepo?utm_source=turborepo.org&amp;utm_medium=referral&amp;utm_campaign=header-enterpriseLink"
                target="_blank" rel="noreferrer" aria-selected="false"
                className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 -ml-2 hidden whitespace-nowrap p-2 md:inline-block text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200">Enterprise</a><a
                className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 -ml-2 hidden whitespace-nowrap p-2 md:inline-block text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
                aria-selected="false" href="/showcase">Showcase</a>
                <div className="nextra-search relative md:w-64 hidden md:inline-block min-w-[200px]">
                    <div
                        ...
                        <input type="search" spellCheck="false"
                               className="block w-full appearance-none rounded-lg px-3 py-2 transition-colors md:text-sm text-base leading-tight bg-black/[.03] dark:bg-gray-50/10 focus:bg-white dark:focus:bg-dark placeholder:text-gray-400 dark:placeholder:text-gray-500 contrast-more:border contrast-more:border-current"
                               value="" placeholder="Search documentation..."/></div>
                </div>
                <a href="https://github.com/vercel/turborepo" target="_blank" rel="noreferrer" aria-selected="false"
                   className="p-2 text-current">
                    ...
                    <span className="sr-only">GitHub</span></a><a href="https://turborepo.org/discord" target="_blank"
                                                                  rel="noreferrer" aria-selected="false"
                                                                  className="p-2 text-current">
                ...
                <span className="sr-only">Discord</span></a>
                <button className="nextra-hamburger rounded active:bg-gray-400/20 p-2 -mr-2 md:hidden">
